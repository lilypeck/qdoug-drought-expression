...
# Q. douglasii gene annotations - need to unzip
...
drought.deseq2 <- read_delim("../Output-data/salmon.isoform.counts.matrix.QUDO_Drought_T2_vs_QUDO_Drought_T1.DESeq2.DE_results.P0.01_C2.DE.subset")
